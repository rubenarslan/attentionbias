...
<div class="atp-sidenav-container span">
	<ul class="nav nav-list atp-affix-sidenav" data-spy="affix" data-offset-top="233">
		...
		<li class="sub"><a href="#trainingsplan"><i class="icon-chevron-right"></i>Trainingsplan</a></li>
		<li class="sub"><a href="#abschlussbefragung"><i class="icon-chevron-right"></i>Abschlussbefragung</a></li>
		<li class="sub"><a href="#untersuchungsdurchfuehrung"><i class="icon-chevron-right"></i>Durchführung</a></li>
		<li><a href="#teilnahme"><i class="icon-chevron-right"></i>Teilnahme</a></li>
		<li><a href="#datenschutz"><i class="icon-chevron-right"></i>Datenschutz</a></li>
	</ul>
</div>
<div class="span8">
...
<section id="wirkung">
	...
	<p>Das ATP für Zwangserkrankte wurde bisher noch nicht überprüft. Unsere Studie soll nun erstmals Aufschluss über die Wirksamkeit des ATP für Zwangserkrankte geben.</p>
</section>

<section id="ablauf">
	<h4>Ablauf</h4>

	<h5>Abklärung zwanghafter Symptome</h5>
	<p>Zu Beginn des Trainings wollen wir Ihre Zwangssymptome und damit verbundenen Probleme genau abklären. Dafür bitten wir Sie, einige Fragebögen auszufüllen, in denen wir Sie nach Ihren Beschwerden fragen. Dieser Schritt ist wichtig, damit wir prüfen können, ob das angebotene Training das richtige für Sie ist. Sollte dies so sein, erhalten Sie dann den Zugang zum Programm.</p>
</section>
